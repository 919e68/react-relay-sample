            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}} ref={(c) => this._nav = c}>
                  ...
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Staffs' href='/staffs' />
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Stations' href='/stations' />
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Transactions' href='/transactions' />
          ...
          <Grid>
            <Row className='fg-white'>
              <Col xs={4} collapseRight>
                <img src='/imgs/app/avatars/default.png' width='40' height='40' className='img-circle'/>
              </Col>
              <Col xs={8} collapseLeft id='avatar-col'>
                <div style={{top: 23, fontSize: 16, lineHeight: 1, position: 'relative'}}>Administrator</div>
                <div>
